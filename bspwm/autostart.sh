...
MONITOR=HDMI1 $HOME/.config/polybar/launch.sh &
MONITOR=eDP1  $HOME/.config/polybar/launch.sh &
...
bspc rule -a evernote-client desktop='^7'
bspc rule -a mpv desktop='^0'
bspc rule -a vlc desktop='^0'
bspc rule -a strawberry desktop='^0'
bspc rule -a pomodoro desktop='^0'
bspc rule -a jetbrains-pycharm-ce desktop='^1'
...
feh --bg-fill /home/jicg/Pictures/Wallpapers/musgo1.jpg &
